...
function AccountDetailsModal({
  ...
  const TEST_EMPTY_DATA = true
   // Change this to true to test empty data
  ...
  const cardData = [
    {
      ...
      data: [
        ...
        { label: 'Account Sub-Type', value: 'Premium Checking', type: 'chip' },
        { label: 'Routing Number', value: '123456789', type: 'text' },
        { label: 'Account Holder Type', value: 'Individual', type: 'chip' },
        { label: 'Tax ID', value: '12-3456789', type: 'text' },
        { label: 'Account Purpose', value: 'Primary Banking', type: 'text' },
        { label: 'Statements Delivery', value: 'Electronic', type: 'status' },
        { label: 'Monthly Fee', value: '$15', type: 'amount' },
        { label: 'Fee Waiver Threshold', value: '$1,500', type: 'amount' },
        { label: 'Overdraft Limit', value: '$500', type: 'amount' },
        { label: 'Daily Transaction Limit', value: '$2,500', type: 'amount' },
        { label: 'ATM Daily Limit', value: '$800', type: 'amount' },
        { label: 'Check Order Count', value: '250', type: 'text' },
        { label: 'Last Statement Date', value: '2024-07-31', type: 'date' },
        { label: 'Next Statement Date', value: '2024-08-31', type: 'date' },
        { label: 'Account Creation Method', value: 'Online Application', type: 'text' },
        { label: 'Initial Deposit', value: '$1,000', type: 'amount' },
        { label: 'Source of Funds', value: 'Employment Income', type: 'text' },
        { label: 'Expected Monthly Deposits', value: '$4,500', type: 'amount' },
        { label: 'Expected Monthly Withdrawals', value: '$3,800', type: 'amount' },
        { label: 'Account Verification Status', value: 'Verified', type: 'status' },
        { label: 'FDIC Insurance', value: 'Active', type: 'status' },
        { label: 'E-Statement Enrollment', value: 'Enrolled', type: 'status' },
        { label: 'Mobile Banking Status', value: 'Active', type: 'status' },
        { label: 'Online Banking Status', value: 'Active', type: 'status' },
        { label: 'Debit Card Status', value: 'Active', type: 'status' },
        { label: 'Checks Issued', value: '47', type: 'text' },
        { label: 'Returned Checks', value: '0', type: 'text' },
        { label: 'NSF Count (YTD)', value: '1', type: 'text' },
        { label: 'Last NSF Date', value: '2024-03-15', type: 'date' },
        { label: 'Average Daily Balance', value: '$2,847', type: 'amount' },
        { label: 'Highest Balance (YTD)', value: '$8,932', type: 'amount' },
        { label: 'Lowest Balance (YTD)', value: '$23', type: 'amount' },
        { label: 'Account Closure Date', value: 'N/A', type: 'text' },
        { label: 'Closure Reason', value: 'N/A', type: 'text' },
        { label: 'Reopen Eligibility', value: 'N/A', type: 'text' },
        { label: 'Customer Segment', value: 'Mass Market', type: 'chip' },
        { label: 'Product Package', value: 'Essential Banking', type: 'text' },
        { label: 'Cross-sell Opportunities', value: 'Credit Card, Loan', type: 'text' },
        { label: 'Relationship Score', value: '7.8/10', type: 'text' },
        { label: 'Profitability Score', value: 'Medium', type: 'chip' },
        { label: 'Risk Score', value: 'Low', type: 'chip' },
        { label: 'Churn Risk', value: 'Low', type: 'chip' }
      ]
    },
    {
      ...
      data: shouldShowEmptyData(1) ? [] : [
        ...
        { label: 'Middle Name', value: 'Michael', type: 'text' },
        { label: 'Maiden Name', value: 'N/A', type: 'text' },
        { label: 'Preferred Name', value: 'Mike', type: 'text' },
        { label: 'Gender', value: 'Male', type: 'text' },
        { label: 'Marital Status', value: 'Married', type: 'chip' },
        { label: 'Nationality', value: 'US Citizen', type: 'text' },
        { label: 'Country of Birth', value: 'United States', type: 'text' },
        { label: 'State of Birth', value: 'California', type: 'text' },
        { label: 'Driver License', value: 'CA D1234567', type: 'text' },
        { label: 'Passport Number', value: 'XXX123456', type: 'text' },
        { label: 'Alternate Phone', value: '+1 (555) 987-6543', type: 'text' },
        { label: 'Work Phone', value: '+1 (555) 444-5555', type: 'text' },
        { label: 'Alternate Email', value: 'work@company.com', type: 'text' },
        { label: 'Mailing Address', value: 'Same as Primary', type: 'text' },
        { label: 'Previous Address', value: '456 Oak Ave, Town, State 67890', type: 'text' },
        { label: 'Address Verification', value: 'Verified', type: 'status' },
        { label: 'Residence Type', value: 'Own Home', type: 'chip' },
        { label: 'Length at Address', value: '3 years 2 months', type: 'text' },
        { label: 'Employer Name', value: 'Tech Solutions Inc.', type: 'text' },
        { label: 'Job Title', value: 'Software Engineer', type: 'text' },
        { label: 'Employment Duration', value: '4 years 1 month', type: 'text' },
        { label: 'Employer Address', value: '789 Business Blvd, Corporate City', type: 'text' },
        { label: 'Previous Employer', value: 'StartUp Ventures LLC', type: 'text' },
        { label: 'Education Level', value: 'Bachelor\'s Degree', type: 'chip' },
        { label: 'University', value: 'State University', type: 'text' },
        { label: 'Emergency Contact', value: 'Jane Doe (Spouse)', type: 'text' },
        { label: 'Emergency Phone', value: '+1 (555) 111-2222', type: 'text' },
        { label: 'Number of Dependents', value: '2', type: 'text' },
        { label: 'Monthly Expenses', value: '$3,200', type: 'amount' },
        { label: 'Other Income', value: '$500', type: 'amount' },
        { label: 'Assets Value', value: '$125,000', type: 'amount' },
        { label: 'Liabilities', value: '$45,000', type: 'amount' },
        { label: 'Net Worth', value: '$80,000', type: 'amount' },
        { label: 'Customer Since', value: '2020-01-15', type: 'date' },
        { label: 'Last Profile Update', value: '2024-06-20', type: 'date' },
        { label: 'Profile Completeness', value: '95%', type: 'text' },
        { label: 'KYC Status', value: 'Complete', type: 'status' },
        { label: 'CIP Verification', value: 'Passed', type: 'status' },
        { label: 'OFAC Check', value: 'Clear', type: 'status' },
        { label: 'PEP Status', value: 'Not PEP', type: 'status' },
        { label: 'Risk Rating', value: 'Low', type: 'chip' },
        { label: 'Customer Tier', value: 'Gold', type: 'chip' }
      ]
    },
    {
      ...
      data: shouldShowEmptyData(2) ? [] : [
        ...
        { label: 'Opening Balance', value: '$1,000', type: 'amount' },
        { label: 'Ledger Balance', value: selectedRow?.balance || 0, type: 'amount' },
        { label: 'Float Amount', value: '$125', type: 'amount' },
        { label: 'Hold Amount', value: '$75', type: 'amount' },
        { label: 'Uncollected Funds', value: '$0', type: 'amount' },
        { label: 'Previous Balance', value: '$42,350', type: 'amount' },
        { label: 'Balance Change', value: '+$2,150', type: 'amount' },
        { label: 'YTD Deposits', value: '$98,750', type: 'amount' },
        { label: 'YTD Withdrawals', value: '$87,230', type: 'amount' },
        { label: 'YTD Net Change', value: '+$11,520', type: 'amount' },
        { label: 'Deposit Count (YTD)', value: '156', type: 'text' },
        { label: 'Withdrawal Count (YTD)', value: '223', type: 'text' },
        { label: 'Check Count (YTD)', value: '47', type: 'text' },
        { label: 'ATM Transactions (YTD)', value: '89', type: 'text' },
        { label: 'Online Transfers (YTD)', value: '134', type: 'text' },
        { label: 'Mobile Deposits (YTD)', value: '23', type: 'text' },
        { label: 'Wire Transfers (YTD)', value: '7', type: 'text' },
        { label: 'ACH Credits (YTD)', value: '24', type: 'text' },
        { label: 'ACH Debits (YTD)', value: '67', type: 'text' },
        { label: 'Card Transactions (YTD)', value: '445', type: 'text' },
        { label: 'International Transactions', value: '12', type: 'text' },
        { label: 'Largest Deposit (YTD)', value: '$8,500', type: 'amount' },
        { label: 'Largest Withdrawal (YTD)', value: '$5,200', type: 'amount' },
        { label: 'Average Deposit', value: '$632', type: 'amount' },
        { label: 'Average Withdrawal', value: '$391', type: 'amount' },
        { label: 'Daily Transaction Limit', value: '$2,500', type: 'amount' },
        { label: 'Monthly Transaction Limit', value: '$50,000', type: 'amount' },
        { label: 'Transactions Today', value: '4', type: 'text' },
        { label: 'Amount Transacted Today', value: '$847', type: 'amount' },
        { label: 'Last Transaction Date', value: '2024-08-05 14:23:00', type: 'datetime' },
        { label: 'Last Transaction Type', value: 'Debit Card Purchase', type: 'text' },
        { label: 'Last Transaction Amount', value: '$42.18', type: 'amount' },
        { label: 'Last Transaction Merchant', value: 'Grocery Store ABC', type: 'text' },
        { label: 'Recurring Payments', value: '8 Active', type: 'text' },
        { label: 'Auto-pay Amount (Monthly)', value: '$1,247', type: 'amount' },
        { label: 'Direct Deposits (Monthly)', value: '2', type: 'text' },
        { label: 'Payroll Deposit Amount', value: '$3,750', type: 'amount' },
        { label: 'Account Sweep Rules', value: 'None', type: 'text' },
        { label: 'Interest Calculation Method', value: 'Daily Balance', type: 'text' },
        { label: 'Interest Rate Tier', value: 'Standard', type: 'chip' },
        { label: 'Interest Accrued (MTD)', value: '$23.45', type: 'amount' },
        { label: 'Service Charges (MTD)', value: '$15.00', type: 'amount' },
        { label: 'Overdraft Fees (YTD)', value: '$35', type: 'amount' },
        { label: 'ATM Fees (YTD)', value: '$18', type: 'amount' },
        { label: 'Foreign Transaction Fees', value: '$12', type: 'amount' },
        { label: 'Statement Cycle', value: 'Monthly', type: 'text' },
        { label: 'Next Statement Date', value: '2024-08-31', type: 'date' },
        { label: 'Check Images Available', value: 'Yes', type: 'status' },
        { label: 'Transaction Alerts', value: 'Enabled', type: 'status' }
      ]
    },
    {
